...
```{r}
rTASSEL::startLogger(fullPath = NULL, fileName = "Mar_08")
```
...
Monodehydroascrobate reductas (MDHAR) - Aplotntioxidant enzyme
```{r}
...
write.csv(result_TAC, "TAC_MLM_stats.csv", row.names = FALSE)
```
