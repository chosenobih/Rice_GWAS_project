...
#GOX plotting
```{r fig.height=4, fig.width=12, dpi=300}
plot_GOX <- plotManhattan(assocRes_MLM_GOX, trait = "GOX", threshold = 5, interactive = FALSE, colors = c("#00AFBB", "#FC4E07"))
png("/home/chosen/Desktop/Rice_GWAS_project/results/plots/rTASSEL_MLM_CON/GOX.png", width=1000, height=400, pointsize = 12)
print(plot_GOX)
dev.off()
```
...
plot_HPR <- plotManhattan(assocRes_MLM_HPR, trait = "HPR", threshold = 5, interactive = FALSE, colors = c("#00AFBB", "#FC4E07"))
png("/home/chosen/Desktop/Rice_GWAS_project/results/plots/rTASSEL_MLM_CON/HPR.png", width=1000, height=400, pointsize = 12)
print(plot_HPR)
dev.off()
```
...
#POX plotting
```{r fig.height=4, fig.width=12}
plot_POX <- plotManhattan(assocRes_MLM_POX, trait = "POX", threshold = 5, interactive = FALSE, colors = c("#00AFBB", "#FC4E07"))
png("/home/chosen/Desktop/Rice_GWAS_project/results/plots/rTASSEL_MLM_CON/POX.png", width=1000, height=400, pointsize = 12)
print(plot_POX)
dev.off()
```
...
#APX plotting
```{r fig.height=4, fig.width=12}
plot_APX <- plotManhattan(assocRes_MLM_APX, trait = "APX", threshold = 5, interactive = FALSE, colors = c("#00AFBB", "#FC4E07"))
png("/home/chosen/Desktop/Rice_GWAS_project/results/plots/rTASSEL_MLM_CON/APX.png", width=1000, height=400, pointsize = 12)
print(plot_APX)
dev.off()
```
...
#GPX plotting
```{r fig.height=4, fig.width=12}
plot_GPX <- plotManhattan(assocRes_MLM_GPX, trait = "GPX", threshold = 5, interactive = FALSE, colors = c("#00AFBB", "#FC4E07"))
png("/home/chosen/Desktop/Rice_GWAS_project/results/plots/rTASSEL_MLM_CON/GPX.png", width=1000, height=400, pointsize = 12)
print(plot_GPX)
dev.off()
```
...
#CAT plotting
```{r fig.height=4, fig.width=12}
plot_CAT <- plotManhattan(assocRes_MLM_CAT, trait = "CAT", threshold = 5, interactive = FALSE, colors = c("#00AFBB", "#FC4E07"))
png("/home/chosen/Desktop/Rice_GWAS_project/results/plots/rTASSEL_MLM_CON/CAT.png", width=1000, height=400, pointsize = 12)
print(plot_CAT)
dev.off()
```
...
#GST plotting
```{r fig.height=4, fig.width=12}
plot_GST <- plotManhattan(assocRes_MLM_GST, trait = "GST", threshold = 5, interactive = FALSE, colors = c("#00AFBB", "#FC4E07"))
png("/home/chosen/Desktop/Rice_GWAS_project/results/plots/rTASSEL_MLM_CON/GST.png", width=1000, height=400, pointsize = 12)
print(plot_GST)
dev.off()
```
...
#SOD plotting
```{r fig.height=4, fig.width=12}
plot_SOD <- plotManhattan(assocRes_MLM_SOD, trait = "SOD", threshold = 5, interactive = FALSE, colors = c("#00AFBB", "#FC4E07"))
png("/home/chosen/Desktop/Rice_GWAS_project/results/plots/rTASSEL_MLM_CON/SOD.png", width=1000, height=400, pointsize = 12)
print(plot_SOD)
dev.off()
```
...
#AO plotting
```{r fig.height=4, fig.width=12}
plot_AO <- plotManhattan(assocRes_MLM_AO, trait = "AO", threshold = 5, interactive = FALSE, colors = c("#00AFBB", "#FC4E07"))
png("/home/chosen/Desktop/Rice_GWAS_project/results/plots/rTASSEL_MLM_CON/AO.png", width=1000, height=400, pointsize = 12)
print(plot_AO)
dev.off()
```
...
#GR plotting
```{r fig.height=4, fig.width=12}
plot_GR <- plotManhattan(assocRes_MLM_GR, trait = "GR", threshold = 5, interactive = FALSE, colors = c("#00AFBB", "#FC4E07"))
png("/home/chosen/Desktop/Rice_GWAS_project/results/plots/rTASSEL_MLM_CON/GR.png", width=1000, height=400, pointsize = 12)
print(plot_GR)
dev.off()
```
...
#Grxs plotting
```{r fig.height=4, fig.width=12}
plot_Grxs <- plotManhattan(assocRes_MLM_Grxs, trait = "Grxs", threshold = 5, interactive = FALSE, colors = c("#00AFBB", "#FC4E07"))
png("/home/chosen/Desktop/Rice_GWAS_project/results/plots/rTASSEL_MLM_CON/Grxs.png", width=1000, height=400, pointsize = 12)
print(plot_Grxs)
dev.off()
```
...
#Trxs plotting
```{r fig.height=4, fig.width=12}
plot_Trxs <- plotManhattan(assocRes_MLM_Trxs, trait = "Trxs", threshold = 5, interactive = FALSE, colors = c("#00AFBB", "#FC4E07"))
png("/home/chosen/Desktop/Rice_GWAS_project/results/plots/rTASSEL_MLM_CON/Trxs.png", width=1000, height=400, pointsize = 12)
print(plot_Trxs)
dev.off()
```
...
#Prxs plotting
```{r fig.height=4, fig.width=12}
plot_Prxs <- plotManhattan(assocRes_MLM_Prxs, trait = "Prxs", threshold = 5, interactive = FALSE, colors = c("#00AFBB", "#FC4E07"))
png("/home/chosen/Desktop/Rice_GWAS_project/results/plots/rTASSEL_MLM_CON/Prxs.png", width=1000, height=400, pointsize = 12)
print(plot_Prxs)
dev.off()
```
...
#Frxs plotting
```{r fig.height=4, fig.width=12}
plot_Frxs <- plotManhattan(assocRes_MLM_Frxs, trait = "Frxs", threshold = 5, interactive = FALSE, colors = c("#00AFBB", "#FC4E07"))
png("/home/chosen/Desktop/Rice_GWAS_project/results/plots/rTASSEL_MLM_CON/Frxs.png", width=1000, height=400, pointsize = 12)
print(plot_Frxs)
dev.off()
```
...
#MDA plotting
```{r fig.height=4, fig.width=12}
plot_MDA <- plotManhattan(assocRes_MLM_MDA, trait = "MDA", threshold = 5, interactive = FALSE, colors = c("#00AFBB", "#FC4E07"))
png("/home/chosen/Desktop/Rice_GWAS_project/results/plots/rTASSEL_MLM_CON/MDA.png", width=1000, height=400, pointsize = 12)
print(plot_MDA)
dev.off()
```
...
#Poly plotting
```{r fig.height=4, fig.width=12}
plot_Poly <- plotManhattan(assocRes_MLM_Poly, trait = "Poly", threshold = 5, interactive = FALSE, colors = c("#00AFBB", "#FC4E07"))
png("/home/chosen/Desktop/Rice_GWAS_project/results/plots/rTASSEL_MLM_CON/Poly.png", width=1000, height=400, pointsize = 12)
print(plot_Poly)
dev.off()
```
...
#ProtOx plotting
```{r fig.height=4, fig.width=12}
plot_ProtOx <- plotManhattan(assocRes_MLM_ProtOx, trait = "ProtOx", threshold = 5, interactive = FALSE, colors = c("#00AFBB", "#FC4E07"))
png("/home/chosen/Desktop/Rice_GWAS_project/results/plots/rTASSEL_MLM_CON/ProtOx.png", width=1000, height=400, pointsize = 12)
print(plot_ProtOx)
dev.off()
```
...
#DHAR plotting
```{r fig.height=4, fig.width=12}
plot_DHAR <- plotManhattan(assocRes_MLM_DHAR, trait = "DHAR", threshold = 5, interactive = FALSE, colors = c("#00AFBB", "#FC4E07"))
png("/home/chosen/Desktop/Rice_GWAS_project/results/plots/rTASSEL_MLM_CON/DHAR.png", width=1000, height=400, pointsize = 12)
print(plot_DHAR)
dev.off()
```
...
#MDHAR plotting
```{r fig.height=4, fig.width=12}
plot_MDHAR <- plotManhattan(assocRes_MLM_MDHAR, trait = "MDHAR", threshold = 5, interactive = FALSE, colors = c("#00AFBB", "#FC4E07"))
png("/home/chosen/Desktop/Rice_GWAS_project/results/plots/rTASSEL_MLM_CON/MDHAR.png", width=1000, height=400, pointsize = 12)
print(plot_MDHAR)
dev.off()
```
...
#TAC plotting
```{r fig.height=4, fig.width=12}
plot_TAC <- plotManhattan(assocRes_MLM_TAC, trait = "TAC", threshold = 5, interactive = FALSE, colors = c("#00AFBB", "#FC4E07"))
png("/home/chosen/Desktop/Rice_GWAS_project/results/plots/rTASSEL_MLM_CON/TAC.png", width=1000, height=400, pointsize = 12)
print(plot_TAC)
dev.off()
```
...
write.csv(result_TAC, "CON_TAC_MLM_stats.csv", row.names = FALSE)
```
